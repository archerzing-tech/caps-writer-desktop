...
async def go():
    try:
        async with websockets.connect('ws://127.0.0.1:6016', open_timeout=3) as ws:
            sr = 16000
            ...
            for i in range(5):
                try:
                    ...
                    if d.get('type') == 'result' or 'text' in d:
                        break
